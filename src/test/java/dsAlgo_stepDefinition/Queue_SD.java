...
public class Queue_SD {
	...
	public void the_user_clicks_the_button_in_queue_panel_or_the_user_select_queue_item_from_the_drop_down_menu(String string) throws InterruptedException {
		queue.clickdata();
		Thread.sleep(1000);
		queue.clickqueue();
	}
...
public void the_user_write_the_invalid_code_in_try_editor_and_click_the_run_button() throws InterruptedException, IOException {
	driver.navigate().back();
	 queue.tryeditorpage();
...
public void the_user_write_the_valid_code_in_try_editor_and_click_the_run_button() throws InterruptedException, IOException {
	driver.navigate().back();
	 queue.tryeditorpage();
