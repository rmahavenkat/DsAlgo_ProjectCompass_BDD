...
public class Array_PF {
	...
	@FindBy(xpath="//a[normalize-space()='Sign in']") WebElement signBtn;
	...
	@FindBy(xpath="//a[@href='array']") WebElement A_getstartedBtn;
	public void clickArrayGetStartBtn() {
	A_getstartedBtn.click();
	}
	@FindBy(xpath="//a[contains(text(),'Data')]") WebElement dropdown;
	public void clickdropdown() {
	dropdown.click();
	}
	@FindBy(xpath="//a[normalize-space()='Arrays']") WebElement arrays;
	...
	@FindBy(xpath="//a[contains(@href, 'try')]") WebElement arrayInpythonTryHere;
	...
	@FindBy(xpath="//*[@id='answer_form']/div/div/div[1]/textarea") WebElement invalidcodeEditor;
	public void enterinvalid(String code) {
	invalidcodeEditor.sendKeys(code);
	}
	@FindBy(xpath="//*[@id='answer_form']/div/div/div[1]/textarea") WebElement validcodeEditor;
	public void entervalid(String validMsg) {
	// WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	//WebElement editor = wait.until(ExpectedConditions.elementToBeClickable(validcodeEditor));
	validcodeEditor.sendKeys(validMsg);
	}
	@FindBy(xpath="") WebElement output;
	...
	@FindBy(xpath="//*[@id='answer_form']/input[2]") WebElement submitBtn;
	...
	@FindBy (id="output") WebElement validoutputmsg;
	public String getoutput() {
	return validoutputmsg.getText();	
	//System.out.println(validoutputmsg.getText());
	}
	@FindBy(xpath="//a[@class='list-group-item list-group-item-light text-info']") WebElement PracticeQBtn;
	public void click_PracticeQBtn() {
	PracticeQBtn.click();
	}
	@FindBy(xpath="//*[@id='output']") WebElement errorMsg ;
	public String getErrorMsg() {
	return errorMsg.getText();
	}
	@FindBy(xpath="//a[@class='btn btn-info']") WebElement arrayUsingListTryHere;
	  public void clickArrayUsingListTryHere() {
	  arrayUsingListTryHere.click();

	}
	  @FindBy(xpath = "//a[@class='btn btn-info']") WebElement basictryhere;
	  public void clickbasictryhere(){
		  basictryhere.click();
	  }
	  @FindBy(xpath = "//a[@class='btn btn-info']") WebElement applicationtryhere;
	  ...
	  @FindBy(xpath="//a[normalize-space()='Search the array']") WebElement searchTheArray;
	  public void clickSearchTheArray(){
		  searchTheArray.click();
	}
	  @FindBy(xpath="//a[normalize-space()='Max Consecutive Ones']") WebElement Max;
	  public void clickMax(){
		  Max.click();
	}
	  @FindBy(xpath="//a[normalize-space()='Find Numbers with Even Number of Digits']") WebElement findNum;
	  public void clickfindNum(){
		  findNum.click();
	}
	  @FindBy(xpath="//a[contains(text(),'Squares of')]") WebElement sortedArray ;
	  public void clicksortedArray(){
		  sortedArray.click();
	}
	  @FindBy(xpath = "//*[@id='output']") WebElement successMsg;
